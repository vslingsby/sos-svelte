  ...
  let compoundAttributes = [
    {
      ...
      value: function (attributes) {
        return Math.floor(
          (getAttrByName("Agility", attributes) +
            getAttrByName("Wit", attributes)) /
            2
        );
      },
    },
    {
      ...
      value: function (attributes) {
        //racial modifiers
        let mob = Math.floor(
          (getAttrByName("Strength", attributes) +
            getAttrByName("Wit", attributes) +
            getAttrByName("Endurance", attributes)) /
            2
        );
    ...
    },
    {
      ...
      value: function (attributes) {
        return Math.floor(
          (getAttrByName("Willpower", attributes) +
            getAttrByName("Wit", attributes) +
            getAttrByName("Perception", attributes)) /
            2
        );
      },
    },
  ...
  <Row>
    {#each attributes as attribute, i}
      <Col>
        <p>{attribute.name}</p>
        <p>
          <input type="number" bind:value={attribute.value} min="1" max="8" />
        </p>
      </Col>
    {/each}
  </Row>
